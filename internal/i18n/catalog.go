...
var catalog = map[Lang]map[string]string{
	EN: {
		...
		"tui_status_config_open": "opened %s",
		...
		"tui_help_list":          " enter open · a add · e edit · d del · / filter · t tag · y copy · o config · L lang · ? help · q quit",
		...
		"tui_placeholder_name":   "alias name (e.g. gh, dev, mail)",
		"tui_placeholder_url":    "target: URL · /path · ~/dir · user@host · me@mail.com · \"shell command\"",
		"tui_placeholder_tags":   "tags, comma separated",
		"tui_placeholder_desc":   "description (optional)",
		"tui_field_type":         "type",
		"tui_type_hint":          "↑/↓ cycles: auto · url · mailto · ssh · file · directory · command",
		...
		"opener_short":              "List, set or unset the apps that open each type / extension",
		"opener_list_short":         "List per-type and per-extension openers",
		"opener_set_short":          "Set the opener for a type (url|mailto|ssh|file|directory) or extension (.pdf, .md, …)",
		"opener_unset_short":        "Remove an opener and fall back to the OS default",
		...
		"onb_action_desc":      "Tie-breaker for bare words like `goto foo`. 'auto' detects. Paths, emails, SSH and URLs are always detected correctly regardless of this setting — it doesn't restrict which types you can save.",
	...
	ES: {
		...
		"tui_status_config_open": "abierto %s",
		...
		"tui_help_list":          " enter abrir · a añadir · e editar · d borrar · / filtrar · t etiqueta · y copiar · o config · L idioma · ? ayuda · q salir",
		...
		"tui_placeholder_name":   "nombre del alias (p.ej. gh, dev, mail)",
		"tui_placeholder_url":    "destino: URL · /ruta · ~/dir · user@host · yo@correo.com · \"comando shell\"",
		"tui_placeholder_tags":   "etiquetas separadas por comas",
		"tui_placeholder_desc":   "descripción (opcional)",
		"tui_field_type":         "tipo",
		"tui_type_hint":          "↑/↓ cambia: auto · url · mailto · ssh · file · directory · command",
		...
		"opener_short":              "Lista, configura o quita las apps que abren cada tipo o extensión",
		"opener_list_short":         "Lista openers por tipo y por extensión",
		"opener_set_short":          "Asigna el opener de un tipo (url|mailto|ssh|file|directory) o extensión (.pdf, .md, …)",
		"opener_unset_short":        "Quita un opener y vuelve al valor por defecto del sistema",
		...
		"onb_action_desc":      "Desempate para palabras sueltas como `goto foo`. 'auto' autodetecta. Rutas, emails, SSH y URLs siempre se detectan bien sin importar este ajuste — no restringe qué tipos puedes guardar.",
